...
$displayName = (Yii::$app->user->isGuest) ? Yii::t('SoulsModule.base', 'Guest') : Yii::$app->user->getIdentity()->displayName;

// Add some configuration to our js module
$this->registerJsConfig("souls", [
    'username' => (Yii::$app->user->isGuest) ? $displayName : Yii::$app->user->getIdentity()->username,
    'text' => [
        'hello' => Yii::t('SoulsModule.base', 'Hi there {name}!', ["name" => $displayName])
    ]
])
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Souls</strong> <?= Yii::t('SoulsModule.base', 'overview') ?></div>
                <div class="panel-body">

                    <p><?= Yii::t('SoulsModule.base', 'Hello Matcher World!') ?></p>

                    <?= Button::primary(Yii::t('SoulsModule.base', 'Say Hello!'))->action("souls.hello")->loader(false); ?>
                </div>
            </div>
